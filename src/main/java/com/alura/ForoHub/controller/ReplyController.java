...
import com.alura.ForoHub.dto.reply.RegisterReplyDTO;
import com.alura.ForoHub.dto.reply.ReplyDTO;
import com.alura.ForoHub.dto.reply.UpdateReplyDTO;
import com.alura.ForoHub.service.reply.ReplyService;
...
public class ReplyController {
    ...
    @PostMapping
    public ResponseEntity<ReplyDTO> registerReply(@RequestBody @Valid RegisterReplyDTO data, UriComponentsBuilder uriBuilder){
