...
public class TopicController {
    ...
    @PostMapping
    public ResponseEntity<NewTopicDTO> registerTopic(@RequestBody @Valid RegisterTopicDTO data, UriComponentsBuilder uriBuilder){
